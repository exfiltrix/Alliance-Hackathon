"""MedSeal proof of concept: tile-level signing of a medical image and tamper detection."""
import hashlib
import time
...
titles = ["1. Оригинал (запечатан)", "2. Подделка: добавлен «узел»", "3. MedSeal: подделка найдена"]
...
fig.tight_layout()
fig.savefig("medseal_check.png", bbox_inches="tight")
print("saved picture")
