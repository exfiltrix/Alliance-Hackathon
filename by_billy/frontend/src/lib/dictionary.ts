...
const dictionary = {
  ...
  a11y: {
    ...
    speechHint: {
      uz: "Yoqilgach, matnni belgilang yoki elementni bosing — u ovoz chiqarib o'qiladi.",
      ru: "После включения выделите текст или нажмите на элемент — он будет прочитан вслух.",
      en: "When on, select text or click an element and it will be read aloud.",
    },
    speechUnsupported: {
    ...
    readPage: { uz: "Sahifani o'qish", ru: "Прочитать страницу", en: "Read this page" },
