...
- [ ] (1) FastAPI app, SQLite tables, `/devices`, `/seal`, `/verify` ported from `reference/muhr_poc.py`
...
## Day 2 — all features
- [ ] (1) PNG `muhr_uid` chunk, hash-chain ledger, `/stats`
...
- "Port `reference/muhr_poc.py` into `backend/app/seal/` as a module with functions `seal_image`, `verify_image`; add pytest tests for the three scenarios in the reference."
